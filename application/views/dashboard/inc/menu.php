	...
	<div class="side_nav">
		...
		<ul>
			...
			<?php if(@$parmsn->create_account ==1 || $prof['role'] == "Super_admin" || @$parmsn->review_account ==1 ): ?>
				...
				<li><a data-toggle="dropdown" id="dropdownMenu1" class="dropdown"data-toggle="dropdown dropdown-toggle" aria-haspopup="true" aria-expanded="false" href="#"><i class="fas fa-rupee-sign"></i> Apply Loan <i class="fas fa-chevron-down"></i></a>
